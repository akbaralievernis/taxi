  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-ink-muted">Управление заказами клиентов · Обновляется автоматически</p>
      </div>
                  ...
                  >
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-sm text-ink-muted truncate flex items-center gap-1">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        ...
                        <div className="text-xs text-ink-subtle">{formatDate(order.createdAt)}</div>
                      </div>
                        ...
                        <div className="p-4 md:p-5 grid md:grid-cols-2 gap-4">
                          <div className="space-y-3 text-sm">
                            <div className="flex items-start gap-2">
                              ...
                              <div>
                                <div className="text-ink-subtle">Телефон</div>
                            ...
                            <div className="flex items-start gap-2">
                              ...
                              <div>
                                <div className="text-ink-subtle">Откуда</div>
                            ...
                            <div className="flex items-start gap-2">
                              ...
                              <div>
                                <div className="text-ink-subtle">Куда</div>
                            ...
                            <div className="flex items-start gap-2">
                              ...
                              <div>
                                <div className="text-ink-subtle">Когда</div>
                          ...
                          <div className="space-y-3 text-sm">
                            <div className="flex items-start gap-2">
                              ...
                              <div>
                                <div className="text-ink-subtle">Пассажиров / Багажа</div>
                            ...
                            <div className="flex items-start gap-2">
                              ...
                              <div>
                                <div className="text-ink-subtle">Класс / Оплата</div>
                            ...
                            {order.comment && (
                              <div className="flex items-start gap-2">
                                ...
                                <div>
                                  <div className="text-ink-subtle">Комментарий</div>
                                  <div className="italic">{order.comment}</div>
                                </div>
                              </div>
                            )}
                            <div className="text-xs text-ink-subtle font-mono">ID: {order.id}</div>
                          </div>
                        </div>

                        {/* Actions */}
                        <div className="p-4 md:p-5 border-t border-border flex flex-wrap gap-2">
                          {order.status === 'pending' && (
                            <button
                              onClick={() => updateStatus(order.id, 'accepted')}
                              className="px-4 py-2 rounded-lg bg-accent-500/20 border border-accent-500/40 text-accent-600 dark:text-accent-300 hover:bg-blue-500/30 transition text-sm flex items-center gap-2"
                            >
                          ...
                          {(order.status === 'pending' || order.status === 'accepted') && (
                            <button
                              ...
                              className="px-4 py-2 rounded-lg bg-pink-500/20 border border-pink-500/40 text-pink-600 dark:text-pink-400 hover:bg-red-500/30 transition text-sm flex items-center gap-2"
                            >
                          ...
                          <button
                            ...
                            className="px-4 py-2 rounded-lg bg-surface-elevated border border-border text-ink-muted hover:bg-pink-500/10 hover:text-pink-600 dark:text-pink-400 transition text-sm flex items-center gap-2 ml-auto"
                          >
