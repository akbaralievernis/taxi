...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/bishkek`, lastModified: now, changeFrequency: 'weekly', priority: 0.9 },
    { url: `${BASE}/osh`, lastModified: now, changeFrequency: 'weekly', priority: 0.9 },
    { url: `${BASE}/karakol`, lastModified: now, changeFrequency: 'weekly', priority: 0.9 },
